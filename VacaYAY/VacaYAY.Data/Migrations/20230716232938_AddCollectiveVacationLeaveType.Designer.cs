...
namespace VacaYAY.Data.Migrations
{
    ...
    [Migration("20230716232938_AddCollectiveVacationLeaveType")]
    partial class AddCollectiveVacationLeaveType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacaYAY.Data.Models.Contract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Contracts", t =>
                        {
                            t.HasCheckConstraint("CK_Contracts_Number_MinLength", "LEN([Number]) >= 6");
                        });
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = "000f4869-1f3a-4d63-a92d-6fa8753aa353",
            ...
            modelBuilder.Entity("VacaYAY.Data.Models.ContractType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacaYAY.Data.Models.Employee", b =>
                {
                    ...
                    b.Property<int>("LastYearsDaysOffNumber")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Employees", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Employees_LastYearsDaysOffNumber_Range", "[LastYearsDaysOffNumber] >= 0 AND [LastYearsDaysOffNumber] <= 2147483647");
                        });
            ...
            modelBuilder.Entity("VacaYAY.Data.Models.VacationReview", b =>
                {
                    ...
                    b.Property<int>("LastYearsDaysTakenOffNumber")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VacaYAY.Data.Models.Contract", b =>
                {
                    ...
                    b.HasOne("VacaYAY.Data.Models.ContractType", "Type")
                        .WithMany()
